...
const int ledPin = 9;    // Pin Digital 9 (mendukung PWM ditandai simbol ~)

// ===================== VARIABEL =====================
// Variabel untuk menyimpan hasil pembacaan dan konversi PWM
int nilaiADC = 0;  // Variabel untuk menampung input 0-1023
int pwm = 0;       // Variabel untuk menampung output 0-255
...
void loop() {
  ...
  // Ubah nilai ADC (10-bit: 0–1023) menjadi nilai PWM (8-bit: 0–255)
  pwm = map(nilaiADC,
            0,      // nilai minimum ADC
  ...
  // ===================== STABILISASI SISTEM =====================
  // Delay agar Serial Monitor tidak bergerak terlalu cepat
  delay(50); 
}